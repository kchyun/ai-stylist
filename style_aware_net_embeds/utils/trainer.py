...
class Trainer:
    ...
    def _train(self, dataloader, epoch):
        ...
        for iter, batch in enumerate(epoch_iterator, start=1):
            ...
            # 랜덤 샘플에 대한 Loss구하기
            B, N_S, H, W, C = neg_random_imgs.shape
            # B, N_S = neg_random_imgs.size(0), neg_random_imgs.size(1)
            neg_random_imgs = neg_random_imgs.view(B*N_S, H, W, C) # (B*N_S, H, W, C)
            ...
            loss_random = compute_loss(anc_projs, pos_projs, neg_random_projs)
